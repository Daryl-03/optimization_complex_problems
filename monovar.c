...
Solution marche_aleatoire(Instance *instance, double max_iterations) {
    ...
    best_solution.cout.cmax = cout_CMax(instance, best_solution.jobOrder);
    ...
    solution_courante.cout.cmax = best_solution.cout.cmax;
